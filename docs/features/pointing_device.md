...
To use the paw 3220 sensor, add this to your `rules.mk`

```make
POINTING_DEVICE_DRIVER = paw3220
```

The paw 3220 sensor uses a serial type protocol for communication, and requires an additional light source. 

| Setting (`config.h`) | Description                                                    | Default                    |
| -------------------- |--------------------------------------------------------------- | -------------------------- |
| `PAW3220_SCLK_PIN`   | (Required) The pin connected to the clock pin of the sensor.   | `POINTING_DEVICE_SCLK_PIN` |
| `PAW3220_SDIO_PIN`   | (Required) The pin connected to the data pin of the sensor.    | `POINTING_DEVICE_SDIO_PIN` |
| `PAW3220_CS_PIN`     | (Required) The pin connected to the cs pin of the sensor.      | `POINTING_DEVICE_CS_PIN` |

The CPI range is 156-4000
