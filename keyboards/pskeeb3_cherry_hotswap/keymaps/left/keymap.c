...
[_QW] = LAYOUT_split_3x5_4(
  ...
  LALT_T(KC_A), LSFT_T(KC_S), LGUI_T(KC_D), LCTL_T(KC_F), KC_G,              LT(_SC, KC_H),    RCTL_T(KC_J), RGUI_T(KC_K), RSFT_T(KC_L), RALT_T(KC_SCLN),
  LCTL_T(KC_Z), KC_X,         KC_C,         KC_V,         KC_B,              KC_N,    KC_M,         KC_COMM,      KC_DOT,       LCTL_T(KC_SLSH),
    TO(_QW),   KC_TAB,  LT(_LO, KC_ENT),  LT(_SC, KC_ESC),      KC_BTN1, RSFT_T(KC_SPC),  LT(_RA, KC_BSPC),  KC_MPLY
),
