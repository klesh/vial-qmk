...
[_RA] = LAYOUT_split_3x5_4(
  KC_QUOT, KC_DQUO, KC_EXLM, KC_ASTR, KC_TILD,      KC_WH_U, KC_UNDS, _______, KC_GRV,  KC_PIPE,
  KC_AT,   KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN,      KC_WH_D, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR,
...
[_SC] = LAYOUT_split_3x5_4(
  ...
  LCTL(KC_Z),   LCTL(KC_X), LCTL(KC_INS), LSFT(KC_INS),              LCTL(KC_LEFT), KC_MNXT, _______,  _______, _______,  KC_MPLY,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [_QW] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_WH_L, KC_WH_R), ENCODER_CCW_CW(KC_LEFT, KC_RIGHT), ENCODER_CCW_CW(KC_UP, KC_DOWN) },
    [_LO] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_WH_L, KC_WH_R), ENCODER_CCW_CW(KC_LEFT, KC_RIGHT), ENCODER_CCW_CW(KC_UP, KC_DOWN) },
    [_RA] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_WH_L, KC_WH_R), ENCODER_CCW_CW(KC_LEFT, KC_RIGHT), ENCODER_CCW_CW(KC_UP, KC_DOWN) },
    [_SC] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_WH_L, KC_WH_R), ENCODER_CCW_CW(KC_LEFT, KC_RIGHT), ENCODER_CCW_CW(KC_UP, KC_DOWN) },
};
#endif
