...
#define TRACKBALL_HUGE_BUG_DRAGSCROLL_REVERSE_Y

//#define POINTING_DEVICE_DEBUG

#define PMW3610_SDIO_PIN    GP10
#define PMW3610_SCLK_PIN    GP11
#define PMW3610_CS_PIN      GP9
#define POINTING_DEVICE_MOTION_PIN  GP12


#define SPDT_DEBOUNCE_START_ROW 0
#define SPDT_DEBOUNCE_END_ROW 4
// #define CAPACITIVE_ROWS {4, 5}
#define CAPACITIVE_ROWS {5}
